...
//username numbers_of_photos private_photos public_photos
$data = array($_SESSION['username'], sizeof($userPhotos), $nPrivate, $nPublic);

$csvFile = $_SESSION['username'].'_stats.csv';
$fp = fopen($csvFile, 'w');
fputcsv($fp, $data);
fclose($fp);
